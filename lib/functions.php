...
<div class="metabox-holder">
	...
	<div class="mce-container">
		...
		<p class="p-author">This <a href="<?php echo MCE_URL ?>" title="This FREE WordPress plugin" alt="This FREE WordPress plugin">FREE WordPress plugin</a> was developed in Chicago by <a href="//atozsites.com" target="_blank" title="WordPress Designers and Developers" alt="WordPress Designers and Developers">atozsites</a>.</p>
...
function spartan_mce_author_wpcf7($mce_supps) {
	...
	if($cfsupp==1)	 {
	 	...
	 	$mce_supps .= mce_referer();
	 	$mce_supps .= '<!-- Chimpmail extension by atozsites -->';
