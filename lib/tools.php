...
function mce_author() {
	...
	$author_name = 'atozsites';
	$author_url = 'https://atozsites.com';
...
define( 'MCE_URL', 'https://github.com/atozsites/mailchimp-contact-form-7' );
define( 'MCE_AUTH', 'https://atozsites.com' );
define( 'MCE_AUTH_COMM', '<!-- campaignmonitor extension by atozsites -->' );
